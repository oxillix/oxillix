...
<details>
<summary><strong><em>👉 Click here to show the roadmap 👈</em></strong></summary>
  
## Coding
### Frontend
In the frontend, I want to specialise in React and React Native. TailwindCSS for styling.
...
#### Theory
![33%](https://progress-bar.dev/33)
- [x] [Django Docs Tutorial](https://docs.djangoproject.com/en/4.1/)
- [ ] [Django for professionals](https://djangoforprofessionals.com/)
- [ ] [Django for API's](https://djangoforapis.com/)

#### Applied
![50%](https://progress-bar.dev/50)
- [x] [Django (3.0) Crash Course Tutorials | Customer Management App](https://www.youtube.com/playlist?list=PL-51WBLyFTg2vW-_6XBoUpE7vpmoR3ztO)
	result -> I ❤ Django 
- [ ] Own app (closed source for now)
...
- [x] [Free Figma UX Design UI Essentials Course](https://www.youtube.com/watch?v=kbZejnPXyLM) - 177m
- [x] [Figma UI Design Tutorial: Get Started in Just 24 Minutes!](https://www.youtube.com/watch?v=FTFaQWZBqQ8) -24m
- [x] [UI Design a Wallet App in Figma](https://www.youtube.com/watch?v=K0f2Lb5yGsk) - 52m
- [ ] [Designing an App in Figma - A Step-by-Step Guide for Beginners](https://www.youtube.com/watch?v=VRf8cyeuxoo) - 54m
- [ ] [Weather App UI Design in Figma](https://www.youtube.com/watch?v=48YwaTiYau0) - 37m
- [ ] [Taxi Call App UI Design in Figma](https://www.youtube.com/watch?v=sXTC38QHv9c) - 51m
- [ ] [Coffee Ordering Mobile App Design in Figma](https://www.youtube.com/watch?v=S8o2ObfX7QE) - 19m
- [ ] [Figma UI Design Course - Create a Bike Shopping App](https://www.youtube.com/watch?v=2C2sxQ4hiS8) - 32m
</details>
